...
const Line = props => <LineEl vectorEffect="non-scaling-stroke" {...props} />;
...
const Path = props => <PathEl vectorEffect="non-scaling-stroke" {...props} />;

export { Svg, Line, Polyline, Circle, Path };
