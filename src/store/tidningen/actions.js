...
import { filesListFolder } from '../../api/dropbox';
import * as constants from './constants';
import config from '../../config';

const addYears = payload => ({
  type: constants.ADD_YEARS,
  payload,
});

const addIssues = payload => ({
...
function getYears(
  accessToken = 'xoOqGJJGdQAAAAAAAAJxfsDKm6BJXnosGfgX8JPQw5Yc2_ZVs4YKhpUwpf4qgFPJ',
) {
